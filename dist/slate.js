(function (global, factory) {
  ...
  var Range = {
    ...
    equals: function equals(range, another) {
      return range && another && Point.equals(range.anchor, another.anchor) && Point.equals(range.focus, another.focus);
    },
    ...
    liftNodes: function liftNodes(editor) {
      ...
      Editor.withoutNormalizing(editor, function () {
        ...
        for (var _i = 0, _pathRefs = pathRefs; _i < _pathRefs.length; _i++) {
          ...
          var _Editor$node = Editor.node(editor, Path.parent(path)),
        ...
        for (var _i5 = 0, _roots = roots; _i5 < _roots.length; _i5++) {
          ...
          if (matches.length > 0) {
            (function () {
              ...
              var _Editor$node7 = Editor.node(editor, commonPath),
                  _Editor$node8 = slicedToArray(_Editor$node7, 1),
                  commonNode = _Editor$node8[0];
  ...
  var matchPath = function matchPath(editor, path) {
    var _Editor$node9 = Editor.node(editor, path),
        _Editor$node10 = slicedToArray(_Editor$node9, 1),
