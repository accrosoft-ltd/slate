import React, { createContext, useContext, useState, useMemo, useCallback, useLayoutEffect, useEffect, useRef } from 'react';
...
var ReactEditor = {
  ...
  findEventRange(editor, event) {
    ...
    if (x == null || y == null) {
      return null; // throw new Error(`Cannot resolve a Slate range from a DOM event: ${event}`)
    }
...
var Editable = props => {
  var {
    ...
    style = {},
    as: Component = 'div',
    showimageditingmodal,
    setUploadOrSelectMediaModalVisible,
    mediaUploadCount,
    googleMapsKey,
    useGoogleJavascriptMaps,
    useGoogleGeocodingMaps,
    useGoogleEmbedMaps,
    setSelectedKeys,
    availableForms,
    weducData,
    ...
    siteRecord
      ...
      attributes = _objectWithoutProperties(props, ["autoFocus", "decorate", "onDOMBeforeInput", "placeholder", "readOnly", "renderElement", "renderLeaf", "style", "as", "showimageditingmodal", "setUploadOrSelectMediaModalVisible", "mediaUploadCount", "googleMapsKey", "useGoogleJavascriptMaps", "useGoogleGeocodingMaps", "useGoogleEmbedMaps", "setSelectedKeys", "availableForms", "weducData", "smartfeedData", "fonts", "siteRecord"]);
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (newDomRange) {
      ...
      var leafEl = newDomRange.startContainer.parentElement; // MK Fix jumpy scroll
