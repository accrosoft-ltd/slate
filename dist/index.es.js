...
var ReactEditor = {
  ...
  findPath(editor, node) {
    ...
    console.error("Unable to find the path for Slate node: ".concat(JSON.stringify(node)));
  },
  ...
  findEventRange(editor, event) {
    ...
    if (x == null || y == null) {
      return null; // console.error(`Cannot resolve a Slate range from a DOM event: ${event}`)
    }
...
var useEditor = () => {
  ...
  if (!editor) {
    console.error("The `useEditor` hook must be used inside the <Slate> component's context.");
  }
...
var useSlate = () => {
  ...
  if (!context) {
    console.error("The `useSlate` hook must be used inside the <SlateProvider> component's context.");
  }
