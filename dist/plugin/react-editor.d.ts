...
export declare const ReactEditor: {
     ...
     */
    toSlateNode(editor: ReactEditor, domNode: DOMNode): Editor | import("slate").Element | import("slate").Text | null;
    /**
     ...
     */
    toSlateRange(editor: ReactEditor, domRange: DOMRange | DOMStaticRange | DOMSelection): Range | null;
};
